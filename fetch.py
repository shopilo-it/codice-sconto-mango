#!/usr/bin/env python3
"""
Recupero codici sconto Mango da shopilo.it
Sursa: https://shopilo.it/negozi/mango.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/mango.com"
STORE_NAME = "Mango"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Mango da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-mango)"
    }
    try:
